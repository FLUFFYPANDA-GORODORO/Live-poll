    ...
    <div className="h-screen max-h-screen bg-[url('/SynegrysphereBG.png')] bg-cover bg-center bg-no-repeat flex flex-col text-rose-50 font-epilogue font-light overflow-hidden relative select-none">
      ...
      <header className="w-full z-20 relative bg-transparent">
        <div className="w-full px-6 py-4 flex items-center justify-between">
          ...
          <div><img src="/SNSlogo.png" alt="Synergy Sphere Logo" className="h-16 2xl:h-20 w-auto object-contain filter drop-shadow-md" /></div>
        </div>
      </header>

      {/* Main Content */}
      <main className="flex-1 flex flex-col justify-between px-6 md:px-12 pt-6 pb-28 z-10 relative w-full mx-auto bg-black/15 rounded-3xl border border-white/5 shadow-2xl my-4">
        {poll.activeQuestionIndex === -1 || poll.activeQuestionIndex === undefined ? (
          <div className="flex-1 flex flex-col items-center justify-center text-center my-auto">
            ...
            <p className="text-rose-400 font-epilogue text-lg md:text-xl 2xl:text-3xl mt-4 opacity-85 tracking-widest uppercase">
              Interactive Session
            </p>
          </div>
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center my-auto">
            ...
            <p className="text-rose-400 font-epilogue text-lg md:text-xl 2xl:text-3xl mt-4 opacity-85 tracking-widest uppercase">
              The Live Poll of Synergy Sphere has Ended
            </p>
          </div>
        ) : (
          <>
              ...
              <div className="w-full flex-1 flex flex-col justify-center items-center mx-auto my-auto mb-6 pt-4">
                {wordsList.length > 0 ? (
                  ...
                  <div className="flex items-center justify-center w-full h-[480px] min-h-[400px]">
                    <svg viewBox="0 0 24 24" className="w-24 h-24 text-rose-400">
                      <path
