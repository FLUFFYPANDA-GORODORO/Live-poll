...
export const api = {
  ...
  getSkills: () => request("GET", "/bidding/skills"),

  addSkill: (data) => request("POST", "/bidding/skills", data, true),

  deleteSkill: (id) => request("DELETE", `/bidding/skills/${id}`, undefined, true),

  startBidding: (pollId) => request("POST", `/bidding/start/${encodeURIComponent(pollId)}`, undefined, true),

  stopBidding: (pollId) => request("POST", `/bidding/stop/${encodeURIComponent(pollId)}`, undefined, true),

  lockInBids: (pollId, sessionId, skillIds) =>
    request("POST", `/bidding/lock-in/${encodeURIComponent(pollId)}`, { sessionId, skillIds }),
