        ...
        return (
          ...
          >
            ...
            <div className="text-center w-full">
              <div
                className="text-sm font-semibold text-slate-700 truncate w-full"
                title={option.text}
              >
  ...
  return (
    <div className="h-screen bg-slate-50 flex flex-col overflow-hidden">
      ...
      <header className="bg-white border-b border-slate-200 flex items-center justify-between shadow-sm z-20 relative h-16">
        <div className="w-96 h-full border-r border-slate-200 flex items-center px-4 gap-3 bg-slate-50">
          <button
              ...
              <div className="space-y-3">
                {activeQuestion?.options.map((option, idx) => (
                  <div key={idx} className="flex items-center gap-2 group">
                    <div
                      className="w-1.5 h-8 rounded-full bg-slate-200 flex-shrink-0"
                      style={{
                        backgroundColor: CHART_COLORS[idx % CHART_COLORS.length],
                      }}
                    />
