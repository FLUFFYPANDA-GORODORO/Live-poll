      ...
      <div className="flex items-center gap-2 mb-2">
        ...
        {canDelete && (
          <button
            ...
            className="ml-auto p-1 rounded text-emerald-400 hover:bg-emerald-50 hover:text-emerald-600 transition-colors"
          >
...
export default function MasterclassCreate({
  title,
  setTitle,
  questions,
  setQuestions,
      ...
      <header className="bg-white border-b border-emerald-100 flex items-center justify-between shadow-sm z-20 relative h-16">
        ...
        <div className="flex items-center gap-3 px-6">
          <button
            ...
            disabled={isSaving}
            className="flex items-center gap-2 px-4 py-2 rounded-lg bg-white border border-emerald-200 text-emerald-600 hover:bg-emerald-50 hover:text-emerald-900 transition-all text-sm font-medium disabled:opacity-50"
          >
            {isSaving ? (
          ...
          <button
            ...
            disabled={isSaving}
            className="flex items-center gap-2 px-5 py-2 rounded-lg bg-gradient-to-r from-emerald-500 to-green-600 text-white font-semibold hover:opacity-90 transition-all shadow-lg shadow-emerald-500/20 text-sm disabled:opacity-70 disabled:cursor-not-allowed"
          >
            {isSaving ? (
              <Loader2 className="w-4 h-4 animate-spin" />
            ) : (
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className="w-64 bg-emerald-50/10 border-r border-emerald-100 flex flex-col h-full">
          <div className="p-4 overflow-y-auto flex-1 space-y-3">
            ...
            <button
              onClick={addQuestion}
              className="w-full p-4 rounded-xl border-2 border-dashed border-emerald-300 text-emerald-500 hover:border-emerald-500 hover:text-emerald-600 hover:bg-emerald-50 transition-all flex items-center justify-center gap-2 font-medium text-sm"
            >
