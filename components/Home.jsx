    ...
    <div className="bg-white relative overflow-hidden font-sans text-slate-900">
      ...
      <div className="relative min-h-screen flex flex-col">
        ...
        <main className="relative z-10 flex flex-col items-center justify-center flex-1 text-center max-w-5xl mx-auto px-4">
          ...
          {/* Top Left */}
          <div
            className="absolute top-[15%] left-[1%] xl:left-[3%] hidden lg:block animate-bounce-slow"
          ...
          {/* Top Right */}
          <div
            className="absolute top-[15%] right-[1%] xl:right-[3%] hidden lg:block animate-bounce-slow"
          ...
          {/* Bottom Left */}
          <div
            className="absolute bottom-[15%] left-[5%] xl:left-[12%] hidden lg:block animate-bounce-slow"
          ...
          {/* Bottom Right */}
          <div
            className="absolute bottom-[18%] right-[5%] xl:right-[12%] hidden lg:block animate-bounce-slow"
          ...
          <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-[var(--color-primary)] mb-6 leading-[1.1]">
            ...
            <span className="relative inline-block">
              manage
              <svg
                className="absolute w-full h-3 -bottom-1 left-0 text-[var(--color-secondary)]"
                viewBox="0 0 100 10"
          ...
          <p className="max-w-2xl text-lg md:text-xl text-slate-500 mb-10 leading-relaxed">
            Manage your polls faster, smarter and more efficiently, delivering
            visibility and data-driven insights to engage your audience.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-slate-500 text-lg max-w-2xl mx-auto">
              A complete live polling platform built for presenters, educators,
              and teams who need instant audience feedback.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-slate-500 text-sm leading-relaxed">
                Participants join with a simple poll ID and vote instantly.
            ...
            <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-slate-500 text-sm leading-relaxed">
                Track total votes, engagement rates, and response breakdowns
            ...
            <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-slate-500 text-sm leading-relaxed">
                Share a unique 6-character poll ID with your audience. No
            ...
            <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-slate-500 text-sm leading-relaxed">
                Create polls with multiple questions, each with customizable
                options. Present them one at a time.
              </p>
            </div>
          </div>
        </div>
      ...
      <footer className="relative z-10 bg-slate-900 text-white py-8 px-6">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center">
            <span className="text-2xl font-bold tracking-tighter text-white whitespace-nowrap">
              Rapid poll
            </span>
          </div>
          <p className="text-slate-400 text-sm">
            &copy; {new Date().getFullYear()} Rapid poll. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
